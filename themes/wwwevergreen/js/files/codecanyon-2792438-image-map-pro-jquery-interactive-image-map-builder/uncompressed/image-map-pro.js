    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            self.loadImage(img, function() {
                ...
                console.log(self.settings.general.image_url);
            }, function() {
                // Image loaded
                console.log('image loaded');
                var html = '';

                html += '<img style="'+ self.getImageStyle() +'" src="'+ self.settings.general.image_url +'">';
        ...
        drawHotspots: function() {
            ...
            for (var i=0; i<self.settings.spots.length; i++) {
                ...
                if (s.type == 'poly') {
                    ...
                    svgHtml += '           <polygon class="hs-hotspot hs-hotspot-poly" style="'+ svgStyle +'" data-index='+ i +' id="'+ s.id +'" points="';
