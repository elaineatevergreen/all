...
Current CSV's to use        line 113
Data Processing             line 143
Delay time                  line 157
Graduate credit max         line 173
...
jQuery(document).ready(function ($) {//Following string contains all of the html displayed on the page before the user does anything.
  ...
  '<option value="1516.csv">2015-16</option><option value="1617.csv">2016-17</option></select>'+
...
function clickFunction() {
  ...
  jQuery(document).ready(function ($) {
    ...
    if(CSV != document.getElementById('selCSV').options[document.getElementById('selCSV').selectedIndex].value ){
        ...
        CSV = "/sites/all/modules/wwwevergreen/js/tuition-calculator" + CSV;
        console.log(CSV);
