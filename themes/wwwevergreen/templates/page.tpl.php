					...
					<form action="http://evergreen.edu/search/home" class="search" method="get" role="search">
						...
						<ul class="element-list search-tools">
							<li class="internal-users-alt"><a href="https://my.evergreen.edu">
								<img alt="User" height="10" src="<?php echo($base_path . $directory) ?>/images/user-32.png" width="10"/> my.evergreen.edu</a></li>
...
<li><a href="http://evergreen.edu/directories.htm">Directories</a></li>
      ...
      <?php else: ?>
      <a href="http://evergreen.edu"><img alt="The Evergreen State College&#8212;Olympia, Washington" src="<?php echo($base_path . $directory) ?>/images/logo.png" srcset="<?php echo($base_path . $directory) ?>/images/evergreen-long-tree-oly.svg 1x, <?php echo($base_path . $directory) ?>/images/evergreen-long-tree-oly.svg 2x"/></a>
...
<section class="site-content">
	...
	<div class="main-background2"><?php print render($page['background_image']); ?></div>
